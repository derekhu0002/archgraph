 ...
 *
 * Usage:
 *   node .opencode/skills/diagram-draw/renderExcalidrawSvg.js <input.excalidraw> [output.svg]
 *
...
function main() {
  ...
  if (!input) {
    console.error('Usage: node .opencode/skills/diagram-draw/renderExcalidrawSvg.js <input.excalidraw> [output.svg]');
    process.exit(1);
  }
