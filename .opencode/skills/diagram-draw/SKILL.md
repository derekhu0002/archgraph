...
- **MUST** 用仓库原生渲染器导出 SVG：`node .opencode/skills/diagram-draw/renderExcalidrawSvg.js docs/diagrams/<name>.excalidraw docs/diagrams/<name>.svg`，并将 SVG 嵌入 README。
...
```powershell
node .opencode/skills/diagram-draw/renderExcalidrawSvg.js docs/diagrams/<name>.excalidraw docs/diagrams/<name>.svg
```
